...
public interface FoodService {
	...
	public List<MyFoodDTO> selectAll_mf(); // 첫화면에서 섭취한 칼로리 정보 리스트로 보여줌
	...
	public int insert(MyFoodVO myFoodVO); // 섭취정보 등록
	public String inputDate(); // 섭취정보 등록 클릭 후 날짜 입력
	public List<FoodDTO> findByName(String name); // 섭취정보 등록 클릭 후 식품명 검색
